...
**<a href="https://www.bib.bund.de/Publikation/2026/Biased-beliefs-beget-biased-beliefs-Teacher-accuracy-and-the-effect-of-report-cards-on-parental.html?nn=115824" style="color:black; text-decoration: underline;" target="_blank" > HThe Messenger Matters: Teacher Accuracy and the Effect of Report Cards on Parental Investment</a>** (with Ariel Kalil).

<details>
    <summary>Abstract</summary>
Many parents overestimate their children's academic abilities, which can reduce parental investment in skill development. Providing parents with performance information can correct these misperceptions, but this paper demonstrates that the effectiveness of such efforts depends on the accuracy of the information source. Using data from the German National Educational Panel Study, we find that around 40 percent of parents and 28 percent of teachers overestimate first-graders' German language skills relative to standardized test scores, and that these biases often concern the same children. Exploiting quasi-experimental variation in report card timing across German states, we show that, on average, report cards correct parents' overestimated beliefs. However, this effect masks substantial heterogeneity. When teachers hold accurate beliefs about children's skills, report cards not only substantially reduce the share of parents’ who overestimate their child’s language skill (by 18 percentage points, p = 0.049) but also increase parent-child reading time by three-quarters of a standard deviation (p = 0.063). When teachers overestimate children's skills, report cards have no effect on parents' beliefs or behavior. These findings suggest that school-provided information can shape parental investment, but only when it is reliable.
</details>
